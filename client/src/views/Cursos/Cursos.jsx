...
import PagamentoEstilo from '../Pagamentos/pagamento';

function Cursos() {
  const [showPagamento, setShowPagamento] = useState(false);

  const handleShowPagamento = () => {
      ...
      <div className="Cursos">
        <header className="header-Cursos">
          <div className='header-logo-Cursos'>
            ...
            <h1 className='logo-japa-Cursos'>Japa dos cortes</h1>
          </div>
        ...
        <section className='course-section'>
          ...
          <div className="course-cards">
            <div className="course-card">
              ...
              <button className="btn-adquirir" onClick={handleShowPagamento}>Adquira</button>
            </div>
